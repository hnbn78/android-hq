...
public class ActPersonalAccountChangeRecord extends AbAdvanceActivity implements View.OnClickListener {
    ...
    private String[] arrayCategory = {"全部", "彩票游戏", "活动", "转账", "修正资金", "充值", "提现"};
    private String[] arrayValue = {"", "7", "90", "3", "80", "1", "2"};
    ...
    public static void launcher(Activity activity, String userName) {
        Intent intent = new Intent(activity, ActPersonalAccountChangeRecord.class);
    ...
    protected void init() {
        ...
        tv_title.setText("个人账变");
        mChuandiUserName = getIntent().getStringExtra("userName");
        initView();
    }

    private void initView() {
        categoryPopup = new ListMenuPopupWindow(ActPersonalAccountChangeRecord.this, AbDevice.SCREEN_WIDTH_PX, arrayCategory);
        ...
        ((TextView) findViewById(R.id.tv6)).setVisibility(View.GONE);
        ...
        adapter = new BaseQuickAdapter<TeamAccountChangeRecord, BaseViewHolder>(R.layout.item_agent_team_account_change_record) {
            ...
            protected void convert(BaseViewHolder helper, TeamAccountChangeRecord item) {
                helper.setVisible(R.id.rl, false);
    ...
    public void search(String username, String zbType, long sTime, long eTime, int page, int size) {
        ...
        HttpAction.getAccountChange(ActPersonalAccountChangeRecord.this, "", zbType, null, startTime, stopTime, page, size, new AbHttpResult() {

            @Override
            public void onBefore(Request request, int id, String host, String funcName) {
                Dialogs.showProgressDialog(ActPersonalAccountChangeRecord.this, "搜索中...");
            }
            ...
            public boolean onSuccessGetObject(int code, int error, String msg, HashMap<String, Object> extra) {
                ...
                if (respAccountChange != null) {
                    ...
                    Toasts.show(ActPersonalAccountChangeRecord.this, msg, false);
                }
                return true;
            }
            ...
            public void onAfter(int id) {
                Dialogs.hideProgressDialog(ActPersonalAccountChangeRecord.this);
