 ...
 */
public class PlaySnakeViewLHC extends FrameLayout {
    ...
    public PlaySnakeViewLHC(@NonNull Context context) {
        super(context);
        init(context);
    }

    public PlaySnakeViewLHC(@NonNull Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        init(context);
    }

    public PlaySnakeViewLHC(@NonNull Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
