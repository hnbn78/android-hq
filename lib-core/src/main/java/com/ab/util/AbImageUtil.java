...
public class AbImageUtil {
	...
	public static Bitmap getScaleBitmap(File file, int desiredWidth, int desiredHeight) {
		...
		//超出的裁掉
		if (desiredHeight != -1 && (resizeBmp.getWidth() > desiredWidth || resizeBmp.getHeight() > desiredHeight)) {
	 ...
	 * @return Bitmap 新图片
	 */
	public static Bitmap getFixedBitmap(File file, int desiredWidth, int desiredHeight) {
