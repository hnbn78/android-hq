...
public class FragTeamDetail extends BasePageFragment {
    int currentPage = 0;
    final int size = 20;
    ...
    public static FragTeamDetail newInstance() {
        FragTeamDetail fragment = new FragTeamDetail();
        return fragment;
    }
                    ...
                    public boolean onSuccessGetObject(int code, int error, String msg, HashMap<String, Object> extra) {
                        if (code == 0 && error == 0) {
                            ...
                            if (list != null && list.getList() != null && list.getList().size() != 0) {
                                ...
                                memberAdapter.notifyDataSetChanged();
                                amount.setText(String.valueOf(list.getTotalCount()));
                                currentPage = page;
                            }
                        }
