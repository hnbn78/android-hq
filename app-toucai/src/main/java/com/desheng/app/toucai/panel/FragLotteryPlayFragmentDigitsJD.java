 ...
 */
public class FragLotteryPlayFragmentDigitsJD extends BaseLotteryPlayFragmentJD {
    ...
    public int getLayoutId() {
        return R.layout.frag_lottery_play_digits_jd;
    }

    @Override
    protected void createCtrlPlay() {
        //配置玩法controller
        setCtrlPlay(new CtrlPlay_Digits_JD(getActivity(), this, getLotteryInfo(), getUiConfig()));
    }
    ...
    public void createPlayModel(View root) {
        if (getHead() != null) {
            getHead().setTvInstructionStatus(View.VISIBLE);
        }
