...
public class ActBindBankCardToucai extends AbAdvanceActivity {
    ...
    public static void launch(Activity ctx, boolean isFirstTime) {
        Intent itt = new Intent(ctx, ActBindBankCardToucai.class);
    ...
    protected void init() {
        ...
        setToolbarRightButtonGroupClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ActWeb.launchCustomService(ActBindBankCardToucai.this);
            }
        });
...
//        }
    ...
    private void selectCity() {
        ...
        CityPickerView mCityPickerView = new CityPickerView(ActBindBankCardToucai.this);
...
//                    Toast.makeText(ActBindBankCardToucai.this, "选择了：" + str, Toast.LENGTH_SHORT).show();
    ...
    private void selectBank() {
        ...
        OptionsPickerView pvOptions = new OptionsPickerView(ActBindBankCardToucai.this);
...
//                }
    ...
    private void submitBind() {
        ...
        HttpAction.bindBankCard(ActBindBankCardToucai.this, bankCode, branch, realName,
                cardNum, fundsPwd, cardType, province, city, county, isFirstTime, new AbHttpResult() {
                    ...
                    public void onBefore(Request request, int id, String host, String funcName) {
                        btSubmit.post(new Runnable() {
                            @Override
                            public void run() {
                                Dialogs.showProgressDialog(ActBindBankCardToucai.this, "");
                            }
                        });
                    }
                    ...
                    public boolean onSuccessGetObject(int code, int error, String msg, HashMap<String, Object> extra) {
                        if (code == 0 && error == 0) {
                            Dialog dialog = DialogsTouCai.showFunOkDialog(ActBindBankCardToucai.this, 0, "绑定成功");
                            ...
                            Toasts.show(ActBindBankCardToucai.this, msg, false);
                        }
                        return true;
                    }
                    ...
                    public void onAfter(int id) {
                        btSubmit.post(new Runnable() {
                            @Override
                            public void run() {
                                Dialogs.hideProgressDialog(ActBindBankCardToucai.this);
                            }
                        });
                    }
                });
    ...
    private void showBindTip(String tip1, String tip2, String right) {
        DialogsTouCai.showBindDialog(ActBindBankCardToucai.this, tip1, tip2, "", right,
    ...
    private void launcherAct(Class cls) {
        Intent intent = new Intent(ActBindBankCardToucai.this, cls);
