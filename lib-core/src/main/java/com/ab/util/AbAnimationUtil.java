...
public class AbAnimationUtil {
    ...
    /**
     * 闪出闪入动画 durationMillis>=400
     * @param v
     * @param durationMillis
     * @param repeatCount  Animation.INFINITE
     * @param repeatMode  Animation.RESTART
     */
    public static void playTwinklingAnimation(final View v,long durationMillis) {
    	   if( null == v ){
               return;
           }
     ...
     * @param view
     */
    public static void startPopup(View view){
        ScaleAnimation viewShowAnimation = new ScaleAnimation(0.6f, 1.2f, 0.4f, 1.2f,
                Animation.RELATIVE_TO_SELF, 0.5f, Animation.RELATIVE_TO_SELF, 0.5f);
        viewShowAnimation.setDuration(300);
        view.startAnimation(viewShowAnimation);
    }
