...
//        HOST_TEST = "http://demo.jinf88.com";
        ...
        AES_LOGIN_KEY = "YCpaRlzmD7Oirkey";
        AES_OPEN_ACCOUNT_KEY = "n5rhN9WJwgMFPtuK";

        if (!BuildConfig.DEBUG) {
            ForceHost = "http://jf2.jyang88.com:8786";
            //TODO 正式
            SWITCH_LINE = HOST_PUBLISH + "/upload/json/app2.json";
            //备用
            //SWITCH_LINE = HOST_PUBLISH + "/jinfeng2/jinfeng2.json";
        } else {
            //TODO 验收
            ForceHost = HOST_TEST;
            SWITCH_LINE = HOST_TEST + "/upload/json/app2.json";
        }
