 ...
 */
public class ComplexTabLayout extends FrameLayout implements ValueAnimator.AnimatorUpdateListener {
    ...
    public ComplexTabLayout(Context context) {
        this(context, null, 0);
    }

    public ComplexTabLayout(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public ComplexTabLayout(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private void addTab(final int position, View tabView) {
        ...
        tabView.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                if (mListener != null && mListener.preTabSelect(position)) {
                    return;
                }
        ...
        if (mTabWidth > 0) {
            if (position == 2) {
                lp_tab = new LinearLayout.LayoutParams(LayoutParams.MATCH_PARENT, LayoutParams.MATCH_PARENT);
            } else {
            ...
            if (mIconVisible) {
                ...
                if (i == 2) {
                    lp = new LinearLayout.LayoutParams(
                            mIconWidth <= 0 ? LinearLayout.LayoutParams.WRAP_CONTENT : (int) (mIconWidth * 1.5),
                            mIconHeight <= 0 ? LinearLayout.LayoutParams.WRAP_CONTENT : (int) (mIconHeight * 1.5));
                } else {
                    lp = new LinearLayout.LayoutParams(
...
//        Log.d("AAA", "mCurrentP--->" + mCurrentP.left + "&" + mCurrentP.right);
    ...
    private OnComplexTabSelectListener mListener;

    public void setOnTabSelectListener(OnComplexTabSelectListener listener) {
    ...
    public interface OnComplexTabSelectListener {
        boolean preTabSelect(int position);
