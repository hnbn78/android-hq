...
public class DayBounsAdapter extends BaseQuickAdapter<List<Params>, BaseViewHolder> {

    public com.desheng.base.adapter.OnItemClickListener<String> onItemClickListener;

    public DayBounsAdapter(@Nullable List<List<Params>> data) {
        super(R.layout.day_bonus_recycler_view, data);
    }
