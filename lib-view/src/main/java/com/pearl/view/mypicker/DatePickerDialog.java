...
public class DatePickerDialog extends Dialog {
    ...
    public static class Builder {
        ...
        public DatePickerDialog create() {
            ...
            LoopView loopHour = view.findViewById(R.id.loop_hour);
            ViewGroup fl_hour = view.findViewById(R.id.fl_hour);
            fl_hour.setVisibility(hasHour?View.VISIBLE:View.GONE);
            ...
            final LoopListener hourLoopListener = new LoopListener() {
                @Override
                public void onItemSelect(int item) {
                    loopHour.setCurrentItem(item);
                }
            };
            loopYear.setListener(maxDaySyncListener);
            loopMonth.setListener(maxDaySyncListener);
            loopDay.setListener(dayLoopListener);
            loopHour.setListener(hourLoopListener);
