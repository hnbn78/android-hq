...
import com.desheng.app.toucai.util.AudioRecoderUtils;
import com.desheng.app.toucai.util.PopupWindowFactory;
...
public class EmotionInputDetector {
    ...
    public EmotionInputDetector bindToPerson(ContactsMode contactsMode) {
    ...
    public EmotionInputDetector bindToEditText(EditText editText) {
        ...
        mEditText.setFilters(emojiFilters);
...
//                }
    ...
    public EmotionInputDetector bindToSendButton(View sendButton) {
        ...
        sendButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (iOnSendNewMessage != null) {
                    iOnSendNewMessage.onSendNewMessage(messageInfo);
                }
    ...
    private IOnSendNewMessage iOnSendNewMessage;

    public void setiOnSendNewMessage(IOnSendNewMessage iOnSendNewMessage) {
        this.iOnSendNewMessage = iOnSendNewMessage;
    }

    public interface IOnSendNewMessage {
        void onSendNewMessage(MessageInfo messageInfo);
    }
    ...
    private InputFilter emojiFilter = new InputFilter() {
        ...
        public CharSequence filter(CharSequence source, int start, int end, Spanned dest, int dstart, int dend) {
            ...
            if (emojiMatcher.find()) {
                Toast.makeText(mActivity, "暂不支持表情输入", Toast.LENGTH_SHORT).show();
                return "";
            }
            return null;
        }
