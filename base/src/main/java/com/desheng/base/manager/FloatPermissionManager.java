...
import com.desheng.base.util.HuaweiUtils;
import com.desheng.base.util.MeizuUtils;
...
public class FloatPermissionManager {
    ...
    private boolean checkPermission(Context context) {
        ...
        if (Build.VERSION.SDK_INT < 23) {
            if (QikuUtils.RomUtils.checkIsMiuiRom()) {
                return miuiPermissionCheck(context);
            } else if (QikuUtils.RomUtils.checkIsMeizuRom()) {
                return meizuPermissionCheck(context);
            } else if (QikuUtils.RomUtils.checkIsHuaweiRom()) {
                return huaweiPermissionCheck(context);
            } else if (QikuUtils.RomUtils.checkIs360Rom()) {
    ...
    private boolean commonROMPermissionCheck(Context context) {
        ...
        if (QikuUtils.RomUtils.checkIsMeizuRom()) {
            return meizuPermissionCheck(context);
        } else {
            Boolean result = true;
            if (Build.VERSION.SDK_INT >= 23) {
