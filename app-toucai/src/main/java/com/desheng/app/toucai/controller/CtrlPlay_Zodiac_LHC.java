 ...
 */
public class CtrlPlay_Zodiac_LHC extends BaseCtrlPlayLHC implements PlayZodiacLHCView.OnBallsChangeListener {
    ...
    public CtrlPlay_Zodiac_LHC(Context ctx, FragLotteryPlayFragmentZodiacLHC frag, LotteryInfo info, LotteryPlayLHCUI uiConfig, LHCQuickPlayController controller) {
    ...
    public void setContentGroup() {
        ...
        //初始化控件
        frag.getPlayZodiacLHCView().setConfig(getUiConfig().getCellUI(), frag.getUserPlayInfoLHC());
        frag.getPlayZodiacLHCView().setBallMultiSelection();
        frag.getPlayZodiacLHCView().setOnBallsChangeListener(this);

        //初始化各组数据
        arrAllBallsSelected = frag.getPlayZodiacLHCView().getArrBallSelected();
    }
    ...
    protected void clearAllSelected() {
        ...
        frag.getPlayZodiacLHCView().syncSelection();
    }
    ...
    public void autoGenerate() {
        ...
        scrollView.realSmoothScrollTo(0, 300, new Animator.AnimatorListener() {
            ...
            public void onAnimationEnd(Animator animation) {
                final PlayZodiacLHCView view = frag.getPlayZodiacLHCView();
