package com.pearl.view.expandablelayout;
...
import com.pearl.view.expandablelayout.util.FastOutSlowInInterpolator;

import static com.pearl.view.expandablelayout.SimpleExpandableLayout.State.COLLAPSED;
import static com.pearl.view.expandablelayout.SimpleExpandableLayout.State.COLLAPSING;
import static com.pearl.view.expandablelayout.SimpleExpandableLayout.State.EXPANDED;
import static com.pearl.view.expandablelayout.SimpleExpandableLayout.State.EXPANDING;

/**
 * 可展开布局, 包裹其中的控件在点击时展开
 * https://github.com/cachapa/ExpandableLayout
 */
public class SimpleExpandableLayout extends FrameLayout {
    ...
    public SimpleExpandableLayout(Context context, AttributeSet attrs) {
        super(context, attrs);

        if (attrs != null) {
            TypedArray a = getContext().obtainStyledAttributes(attrs, R.styleable.SimpleExpandableLayout);
            duration = a.getInt(R.styleable.SimpleExpandableLayout_el_duration, DEFAULT_DURATION);
            expansion = a.getBoolean(R.styleable.SimpleExpandableLayout_el_expanded, false) ? 1 : 0;
            orientation = a.getInt(R.styleable.SimpleExpandableLayout_android_orientation, VERTICAL);
            parallax = a.getFloat(R.styleable.SimpleExpandableLayout_el_parallax, 1);
            a.recycle();
