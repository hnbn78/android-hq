...
import com.desheng.app.toucai.panel.FragLotteryPlayFragmentDigitsAllInOne;
 ...
 */
public class CtrlPlay_DigitsAllInOne extends BaseCtrlPlay implements PlayDigitView.OnBallsChangeListener {
    ...
    public CtrlPlay_DigitsAllInOne(Context ctx, FragLotteryPlayFragmentDigitsAllInOne frag, LotteryInfo info, LotteryPlayUIConfig uiConfig, LotteryPlay play) {
...
//                        }
    ...
    public void refreshCurrentUserPlayInfo(Object userPlayInfo) {
        // 更新奖金
        getLotteryPanel().getFootView().setLotteryInfo(getLotteryPlay(), (LotteryPlayUserInfo) userPlayInfo);
    }
    ...
    public String getRequestText() {
        ...
        //特殊规则
        if (getLotteryPlay().getPlayId().equals("sixzux4h") && getLotteryPanel().getSnakeBar().getHitCount() < 2) {
            return "";
        }
