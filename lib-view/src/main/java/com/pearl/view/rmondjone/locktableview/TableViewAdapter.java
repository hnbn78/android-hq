...
public class TableViewAdapter extends RecyclerView.Adapter<TableViewAdapter.TableViewHolder> {
     ...
     * 表格第一列字体颜色
     */
    private int mTableFirstRowTextColor;
    /**
     * 表格内容字体颜色
     */
    ...
    public void onBindViewHolder(final TableViewHolder holder, int position) {
        ...
        if (isLockColumn) {
            ...
            if (mLockAdapter == null) {
                ...
                mLockAdapter.setFirstRowTextColor(mTableFirstRowTextColor);
                ...
                if(mOnCellLongClickListener != null){
                    mLockAdapter.setOnCellLongClickListener(mOnCellLongClickListener);
                }
        ...
        if (mUnLockAdapter == null) {
            ...
            mUnLockAdapter.setTableContentTextColumnColors(mTableContentTextColumnColors);
            ...
            if (onCellClickListenter != null) {
                mUnLockAdapter.setOnCellClickListenter(onCellClickListenter);
            }

            if(mOnCellLongClickListener !=null){
                mUnLockAdapter.setOnCellLongClickListener(mOnCellLongClickListener);
            }
    ...
    public void setTableContentTextColumnColors(String[] mTableContentTextColumnColors) {
        this.mTableContentTextColumnColors = mTableContentTextColumnColors;
    }
    ...
    public void setFirstRowTextColor(int mTableFirstRowTextColor){
        this.mTableFirstRowTextColor= mTableFirstRowTextColor;
    }
