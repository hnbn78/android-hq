 ...
 */
public class CtrlPlay_Board_LHC extends BaseCtrlPlayLHC implements PlayBoardLHCView.OnBallsChangeListener {
    

    protected boolean[] arrAllBallsSelected = null;

    private LotteryPlayUserInfoLHC userPlayInfo;
    public CtrlPlay_Board_LHC(Context ctx, BaseLotteryPlayFragmentLHC frag, LotteryInfo info, LotteryPlayLHCUI uiConfig, LHCQuickPlayController controller) {
    ...
    public void setContentGroup() {
        ...
        //初始化控件
        frag.getBoardGroup().setConfig(getUiConfig().getCellUI(), frag.getUserPlayInfoLHC());
        frag.getBoardGroup().setBallMultiSelection();
        frag.getBoardGroup().setOnBallsChangeListener(this);

        //初始化各组数据
        arrAllBallsSelected = frag.getBoardGroup().getArrBallSelected();
    }
    ...
    protected void clearAllSelected() {
        ...
        frag.getBoardGroup().syncSelection();
    }
    ...
    public void autoGenerate() {
        ...
        scrollView.realSmoothScrollTo(0, 300, new Animator.AnimatorListener() {
            ...
            public void onAnimationEnd(Animator animation) {
                final PlayBoardLHCView view = frag.getBoardGroup();
