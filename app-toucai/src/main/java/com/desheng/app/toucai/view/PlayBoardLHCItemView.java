...
public class PlayBoardLHCItemView extends FrameLayout {
    ...
    public PlayBoardLHCItemView(Context context) {
        super(context);
        init();
    }

    public PlayBoardLHCItemView(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        init();
    }

    public PlayBoardLHCItemView(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        init();
    }

    private void init() {
        View view = View.inflate(getContext(), R.layout.view_lottery_play_board_lhc_item, null);
