...
public class ActThirdTeamReport extends AbAdvanceActivity implements NameChainAdapter.OnItemClickListener {
    public static void launch(Activity ctx) {
        simpleLaunch(ctx, ActThirdTeamReport.class);
    }
    ...
    protected int getLayoutId() {
        return R.layout.act_third_team_report;
    }
    ...
    public void search(String username, long sTime, long eTime,
        ...
        HttpAction.getThirdTeamReport(ActThirdTeamReport.this, username, startTime, stopTime, page, size, new AbHttpResult() {

            @Override
            public void onBefore(Request request, int id, String host, String funcName) {
                if (page == 0) {
                    Dialogs.showProgressDialog(ActThirdTeamReport.this, "搜索中...");
                }
            ...
            public boolean onSuccessGetObject(int code, int error, String msg, HashMap<String, Object> extra) {
                ...
                if (respSearchOrder != null) {
                    ...
                    totalCount = respSearchOrder.getTotalCount();
                    listOrders.addAll(respSearchOrder.getList());

                    for (int i = 0; i < listOrders.size(); i++) {
                        ArrayList<String> mRowDatas = new ArrayList<String>();
                        ThirdTeamReportBean.ListBean listBean = listOrders.get(i);
                        mRowDatas.add(Strs.isEmpty(listBean.getUserName()) ? "总计" : listBean.getUserName());
                        mRowDatas.add(Nums.formatDecimal(listBean.getTransferInAmount(), 3));
                        mRowDatas.add(Nums.formatDecimal(listBean.getTransferOutAmount(), 3));
                        mRowDatas.add(Nums.formatDecimal(listBean.getConfirmAmount(), 3));

                        mRowDatas.add(Nums.formatDecimal(listBean.getAwardAmount(), 3));
                        mRowDatas.add(Nums.formatDecimal(listBean.getProfitAmount(), 3));
...
//                        Toasts.show(ActTeamReports.this, "已经全部加载完毕!");
                    ...
                    Toasts.show(ActThirdTeamReport.this, msg, false);
                }
                return true;
            }
            ...
            public void onAfter(int id) {
                if (page == 0) {
                    Dialogs.hideProgressDialog(ActThirdTeamReport.this);
                }
                if (ActThirdTeamReport.this.mXRecyclerView != null) {
                    ActThirdTeamReport.this.mXRecyclerView.refreshComplete();
                    ActThirdTeamReport.this.mXRecyclerView.loadMoreComplete();
                }
            }
        });
    }
...
//                        Log.e("滚动边界","滚动到最右边");
                ...
                .setOnLoadingListener(new LockTableView.OnLoadingListener() {
                    ...
                    public void onRefresh(XRecyclerView mXRecyclerView, final ArrayList<ArrayList<String>> mTableDatas) {
                        ActThirdTeamReport.this.mXRecyclerView = mXRecyclerView;
                ...
                .setOnItemClickListenter(new LockTableView.OnItemClickListenter() {
                    ...
                    public void onItemClick(View item, int position) {
                        ...
                        subName = listOrders.get(position - 1).getUserName();
                        if(null!=subName){
                            subnamelist.clear();
                            currPage = 0;
                            etUserName.setText(subName);
