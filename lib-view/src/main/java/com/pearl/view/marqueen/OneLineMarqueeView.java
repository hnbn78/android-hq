package com.pearl.view.marqueen;
...
public class OneLineMarqueeView extends View implements Runnable {
    ...
    public OneLineMarqueeView(Context context) {
        this(context, null);
    }

    public OneLineMarqueeView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public OneLineMarqueeView(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private void initattrs(AttributeSet attrs) {
        TintTypedArray tta = TintTypedArray.obtainStyledAttributes(getContext(), attrs,
                R.styleable.OneLineMarqueeView);

        textColor = tta.getColor(R.styleable.OneLineMarqueeView_marqueeview_text_color, textColor);
        isClickStop = tta.getBoolean(R.styleable.OneLineMarqueeView_marqueeview_isclickalbe_stop, isClickStop);
        isResetLocation = tta.getBoolean(R.styleable.OneLineMarqueeView_marqueeview_is_resetLocation, isResetLocation);
        speed = tta.getFloat(R.styleable.OneLineMarqueeView_marqueeview_text_speed, speed);
        textSize = tta.getFloat(R.styleable.OneLineMarqueeView_marqueeview_text_size, textSize);
        textDistance1 = tta.getInteger(R.styleable.OneLineMarqueeView_marqueeview_text_distance, textDistance1);
        startLocationDistance = tta.getFloat(R.styleable.OneLineMarqueeView_marqueeview_text_startlocationdistance, startLocationDistance);
        repetType = tta.getInt(R.styleable.OneLineMarqueeView_marqueeview_repet_type, repetType);
        tta.recycle();
    }
