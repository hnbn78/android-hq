...
public class MaterialDialog {
    ...
    public void showWithAnim() {
        if (!mHasShow) {
            ...
            mAlertDialog.getWindow().setWindowAnimations(R.style.dialogWindowAnim); //设置窗口弹出动画
            mAlertDialog.show();
        }
        mHasShow = true;
        isShowing = true;
    ...
    public MaterialDialog setPositiveButton(int resId, final View.OnClickListener listener) {
        ...
        if (mBuilder != null) {
            mBuilder.setPositiveButton(this.nText, nListener);
        }
        return this;
    }
    ...
    public MaterialDialog setPositiveButton(String text) {
        this.pText = text;
        if (mBuilder != null) {
            mBuilder.setPositiveButton(this.pText);
        }
        return this;
    }
    ...
    public MaterialDialog setNegativeButton(int resId, final View.OnClickListener listener) {
        this.nId = resId;
        this.nText = Views.fromStrings(resId);
        this.nListener = listener;
        if (mBuilder != null) {
            mBuilder.setNegativeButton(this.nText, nListener);
        }
        return this;
    }
    ...
    private class Builder {
        ...
        private Builder() {
            ...
            if (mBackgroundDrawable != null) {
                LinearLayout linearLayout = (LinearLayout) mAlertDialogWindow.findViewById(R.id.material_background);
                ViewCompat.setBackground(linearLayout, mBackgroundDrawable);
//                linearLayout.setBackground(mBackgroundDrawable);
        ...
        public void setMessage(int resId) {
            if (mMessageView != null) {
                ...
                mAlertDialogWindow.getDecorView().requestLayout();
            }
        }
         ...
         * @param text the name of material_dialog_button
         */
        public void addPositiveButton(String text, final View.OnClickListener listener) {
         ...
         * @param text the name of material_dialog_button
         */
        public void addNegativeButton(String text, final View.OnClickListener listener) {
            Button button = new Button(mContext);
            LinearLayout.LayoutParams params = new LinearLayout.LayoutParams(LinearLayout.LayoutParams.WRAP_CONTENT, LinearLayout.LayoutParams.WRAP_CONTENT);
            button.setLayoutParams(params);
            button.setBackgroundResource(R.drawable.material_card);
