...
public class RoundConerImageView extends AppCompatImageView {
    ...
    private void inital(Context context, AttributeSet attrs) {
        ...
        TypedArray array = context.obtainStyledAttributes(attrs,
                R.styleable.RoundConerImageView);
        borderRadius = dp2px(array.getDimension(R.styleable.RoundConerImageView_borderRadius, BORDER_RADIUS_DEFAULT));
        type = array.getInt(R.styleable.RoundConerImageView_type, TYPE_NORMAL);
        border_width = dp2px(array.getDimension(R.styleable.RoundConerImageView_borderWidth, BORDER_WIDTH));
        border_color = array.getInt(R.styleable.RoundConerImageView_borderColor, BORDER_COLOR);
        array.recycle();
    }
