...
package com.pearl.view.advrecyclerview.decoration;
...
public class ItemShadowDecorator extends RecyclerView.ItemDecoration {
     ...
     * @param shadow 9-patch drawable used for drop shadow
     */
    public ItemShadowDecorator(@NonNull NinePatchDrawable shadow, double scale) {
        this(shadow, true);
        this.scale = scale;
    }
    ...
    public void onDraw(Canvas c, RecyclerView parent, RecyclerView.State state) {
        ...
        for (int i = 0; i < childCount; i++) {
            ...
            final int left = (int) (child.getLeft() - mShadowPadding.left * scale);
            final int right = (int) (child.getRight() + mShadowPadding.right * scale);
            final int top = (int) (child.getTop() - mShadowPadding.top * scale);
            final int bottom = (int) (child.getBottom() + mShadowPadding.bottom * scale);
