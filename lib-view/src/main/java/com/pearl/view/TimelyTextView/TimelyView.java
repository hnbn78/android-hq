package com.pearl.view.TimelyTextView;
...
import com.pearl.view.TimelyTextView.animation.TimelyEvaluator;
import com.pearl.view.TimelyTextView.model.NumberUtils;

public class TimelyView extends View {
    private static final float                           RATIO                   = 1f;
    private static final com.nineoldandroids.util.Property<TimelyView, float[][]> CONTROL_POINTS_PROPERTY = new Property<TimelyView, float[][]>(float[][].class, "controlPoints") {
        @Override
