 ...
 */
public class ActBindPhone extends AbAdvanceActivity implements View.OnClickListener {
    private String verifyCode, phoneSms;
    private CountDownTimer smsTimer;

    public static void launch(Activity act) {
        Intent itt = new Intent(act, ActBindPhone.class);
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            case R.id.ivRegistBtn:
                ...
                if (!Views.checkTextAndToast(ActBindPhone.this, phone, "请输入正确手机号码!")) {
                    return;
                }
                String smsVerifyCode = Views.getText(etSmsVerify);
                if (!Views.checkTextAndToast(ActBindPhone.this, smsVerifyCode, "请输入短信验证码!")) {
                    return;
                }
                bindPhone(phone, smsVerifyCode);
                break;
            case R.id.tvSendMsg:
                phoneSms = Views.getText(etPhone);
                if (!Views.checkTextAndToast(ActBindPhone.this, phoneSms, "请输入正确手机号码!")) {
                    return;
                }
                onSendCode();
                break;
    ...
    private void onSendCode() {
        UserManager.getIns().getSmsCode2(ActBindPhone.this, phoneSms, verifyCode, new AbCodeCallBack() {
            @Override
     ...
     * 绑定手机号
     */
    private void bindPhone(String phone, String pwd) {
        HttpAction.bindPhone(null, phone, pwd, new AbHttpResult() {
            @Override
            ...
            public boolean onSuccessGetObject(int code, int error, String msg, HashMap<String, Object> extra) {
                ...
                Toasts.show(ActBindPhone.this, msg);
            ...
            public boolean onError(int status, String content) {
                Toasts.show(ActBindPhone.this, content);
