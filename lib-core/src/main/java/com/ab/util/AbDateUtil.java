...
public class AbDateUtil {
    ...
    /**
     * @return 获取当前日最近一个月的日期集合
     */
    public static List<String> getLastMonthDate() {
        return getDatesBetweenTwoDate(getupMonthDate(getCurrentDate()), getCurrentDate());
    }

    /**
     * @param beginDate 开始时间
     * @param endDate   结束时间
     * @return 返回两个日期内的所有date集合
     */
    public static List<String> getDatesBetweenTwoDate(Date beginDate, Date endDate) {
        ...
        lDate.add(sdf.format(cal.getTime()));//把结束时间加入集合
        return lDate;
    }
