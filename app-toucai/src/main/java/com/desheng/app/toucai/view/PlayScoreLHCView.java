 ...
 */
public class PlayScoreLHCView extends GridLayout {
    ...
    public PlayScoreLHCView(@NonNull Context context) {
        super(context);
    }

    public PlayScoreLHCView(@NonNull Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
    }

    public PlayScoreLHCView(@NonNull Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
    ...
    public void setConfig(List<LotteryPlayLHCUI.CellUIBean> layoutBeans, LotteryPlayUserInfoLHC userInfoLHC) {
        ...
        //width -= Views.dp2px(16);
        //width /= 2;

        for (int i = 0; i < layoutBeans.size(); i++) {
            LotteryPlayLHCUI.CellUIBean bean = layoutBeans.get(i);
            PlayScoreLHCItemView view = new PlayScoreLHCItemView(getContext());
            view.setUIConfig(bean, userInfoLHC);
            //addView(view, i, new GridLayout.LayoutParams(new ViewGroup.LayoutParams(width, ViewGroup.LayoutParams.MATCH_PARENT)));
            addView(view);
            view.setTag(i);
