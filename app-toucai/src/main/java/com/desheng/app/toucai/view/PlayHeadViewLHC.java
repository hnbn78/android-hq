 ...
 */
public class PlayHeadViewLHC extends FrameLayout{
    ...
    public PlayHeadViewLHC(@NonNull Context context) {
        super(context);
        init(context);
    }

    public PlayHeadViewLHC(@NonNull Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        init(context);
    }

    public PlayHeadViewLHC(@NonNull Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
    ...
    private void init(Context context) {
        View inner = LayoutInflater.from(context).inflate(R.layout.view_lottery_play_head_lhc, this, false);
    ...
    public void setMoney(double money){
        String string = String.format("￥ <font color=#ff0000>%s</font>", Nums.formatDecimal(money, 3));
