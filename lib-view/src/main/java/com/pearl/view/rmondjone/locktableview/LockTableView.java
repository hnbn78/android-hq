...
public class LockTableView {
    ...
    private OnCellClickListenter mOnCellClickListenter;
...
//            Log.e("每行数据", mTableRowDatas.toString());
    ...
    private void initView() {
        ...
        mTableViewAdapter.setFirstRowTextColor(mTableFirstRowTextColor);
        ...
        if (mOnCellClickListenter != null) {
            mTableViewAdapter.setOnCellClickListenter(mOnCellClickListenter);
        }
        ...
        if(mOnCellLongClickListener != null){
            mTableViewAdapter.setOnCellLongClickListener(mOnCellLongClickListener);
        }
        ...
        mTableViewAdapter.setTableContentTextColumnColors(mTableContentTextColumnColors);
    ...
    public LockTableView setFirstRowTextColor(int mTableFirstRowTextColor){
    ...
    public LockTableView setTableContentTextColumnColors(String [] mTableContentTextColors) {
    ...
    public LockTableView setOnCellClickListenter(OnCellClickListenter mOnCellClickListenter) {
        this.mOnCellClickListenter = mOnCellClickListenter;
        return this;
    }
    ...
    public LockTableView setOnCellLongClickListener(OnCellLongClickListener mCellLongClickListner){
        this.mOnCellLongClickListener =mCellLongClickListner;
        return this;
    }
     ...
     * 创建时间 2018/2/2 下午4:50
     */
    public interface OnCellClickListenter {

        /**
         * @param item     点击项
         */
        void onCellClick(View item, int row, int column, String data);
    }
    ...
    public interface OnCellLongClickListener {
         ...
         * @param position 点击位置
         */
        void onCellLongClick(View item, int row, int column, String data);
    }
